...
- `Ctrl`/`Cmd` + `Z` or the undo button restores the previous selection, including a whole parent/child replacement or clear operation. Up to 50 changes are retained per session. The selected list supports individual removal.
